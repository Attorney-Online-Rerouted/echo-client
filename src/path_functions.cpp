...
QString AOApplication::get_pos_path(const QString &pos, const bool desk)
{
  ...
  if (pos == "def" && file_exists(get_image_suffix(get_background_path("defenseempty"))))
  {
    f_background = "defenseempty";
    f_desk_image = "defensedesk";
  }
  else if (pos == "pro" && file_exists(get_image_suffix(get_background_path("prosecutorempty"))))
  {
    f_background = "prosecutorempty";
    f_desk_image = "prosecutiondesk";
  }
  else if (pos == "jud" && file_exists(get_image_suffix(get_background_path("judgestand"))))
  {
  ...
  else if (pos == "hlp" && file_exists(get_image_suffix(get_background_path("prohelperstand"))))
  {
    f_background = "prohelperstand";
    f_desk_image = "prohelperdesk";
  }
  else if (pos == "jur" && file_exists(get_image_suffix(get_background_path("jurystand"))))
  {
    f_background = "jurystand";
    f_desk_image = "jurydesk";
  }
  else if (pos == "sea" && file_exists(get_image_suffix(get_background_path("seancestand"))))
  {
...
QString AOApplication::get_asset(QString p_element, QString p_theme, QString p_subtheme, QString p_default_theme, QString p_misc, QString p_character, QString p_placeholder)
{
  ...
  if (ret.isEmpty())
  {
    qWarning().nospace() << "could not find asset " << p_element << " (theme = " << p_theme << ", misc = " << p_misc << ", char = " << p_character << ")";
  }
  return ret;
}
...
QString AOApplication::get_image(QString p_element, QString p_theme, QString p_subtheme, QString p_default_theme, QString p_misc, QString p_character, QString p_placeholder, bool static_image)
{
  ...
  if (ret.isEmpty())
  {
    qWarning().nospace() << "could not find image " << p_element << " (theme = " << p_theme << ", misc = " << p_misc << ", char = " << p_character << ", static = " << static_image << ")";
  }
  return ret;
}
...
QString AOApplication::get_sfx(QString p_sfx, QString p_misc, QString p_character)
{
  ...
  if (ret.isEmpty())
  {
    qWarning().nospace() << "could not find sfx " << p_sfx << " (char = " << p_character << ", misc = " << p_misc << ")";
  }
  return ret;
}
...
QString AOApplication::get_real_path(const VPath &vpath, const QStringList &suffixes)
{
  ...
  if (!phys_path.isEmpty() && exists(phys_path))
  {
    ...
    { // make sure cached asset is the right type
